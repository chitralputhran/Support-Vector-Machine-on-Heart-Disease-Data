# Support Vector Machine on Heart Disease Data

![pairplot](Pairplot.jpg)

The data used for this project can found [here](https://www.kaggle.com/ronitf/heart-disease-uci) <br>
**Thank you for going through my GitHub repository!**<br><br>
In this project, I have used python libraries within the data science ecosystem to process and predict heart disease positive data instances, based on supporting features included in the data set, with the help of machine learning.
